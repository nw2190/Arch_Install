...
*Note*: The Arch USB was not able to detect the laptop's hard drive on my first installation attempt.  This issue was resolved by disabling Bitlocker Encryption on Windows and changing the SATA operating mode to `AHCI` in my case.
