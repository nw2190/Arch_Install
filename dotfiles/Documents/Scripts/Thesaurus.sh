...
clear
query=$1
result="$(sdcv -c -u 'Merriam-Webster Collegiate® Thesaurus' ${query}|html2text --ignore-emphasis)"

#parsedresult="\\n${result//\\-->/\\n}\\n\\n"
#printf "$parsedresult"
parsedresult="${result//\\-->/\\n}\\n\\n"
parsedresult="${parsedresult//---|---/  }"
parsedresult="${parsedresult//Thesaurus/  }"
parsedresult="${parsedresult//Merriam-Webster Collegiate®/Merriam-Webster Collegiate® Thesaurus}"
parsedresult="${parsedresult//Found 1 items, similar to test./  }"

parsedresult="${parsedresult//1 items, similar to ${query}./}"

# Reformat numbered list entries
parsedresult="${parsedresult//
1 /\\n1.)  }"
parsedresult="${parsedresult//
2 /\\n\\n2.)  }"
